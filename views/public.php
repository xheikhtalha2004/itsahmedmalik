...
function public_render_contact(string $html): string
{
    ...
    $contactForm = '<form class="contact-form-card" action="/api/contact.php" method="post">'
        ...
        . '<div class="honeypot-field" aria-hidden="true"><label>Website <input type="text" name="website" tabindex="-1" autocomplete="off" /></label></div>'
    ...
    $meeting = '<div class="meeting-modal" id="meeting-modal" aria-hidden="true"><div class="meeting-modal-backdrop" data-close-meeting-modal></div>'
        ...
        . '<div class="honeypot-field" aria-hidden="true"><label>Website <input type="text" name="website" tabindex="-1" autocomplete="off" /></label></div>'
        . '<div class="meeting-scheduler"><div class="meeting-calendar-panel">'
        ...
        . '<div class="contact-input-group"><label for="meeting-phone">Phone</label><input class="contact-input" id="meeting-phone" name="phone" type="tel" autocomplete="tel" minlength="7" maxlength="32" required /></div></div>'
        . '<div class="meeting-slots-panel"><div class="contact-input-group"><label for="meeting-date">Preferred date</label><input class="contact-input" id="meeting-date" name="date" type="date" min="' . $minDate . '" max="' . $maxDate . '" required /></div>'
        . '<div class="contact-input-group"><label for="meeting-time">Preferred time (PKT)</label><input class="contact-input" id="meeting-time" name="time" type="time" step="1800" required /></div>'
